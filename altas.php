...
<head>
     ...
     <link rel="stylesheet" type="text/css" href="estilos/estilos.css"><center><h1>Bievenidos al Sistema de Actividades Culturales y Deportivas :D xD ;) :) </h1></center>
...
<script>
	...
	function enviado()
	{
		...
		var actValido=document.getElementById('act').checkValidity();

		if(nValido, apValido, amValido, maValido, caValido, edValido, seValido, sValido, actValido)
...
<body>
	...
	<center><h1>Registro</h1></title></center>
			...
			<input type="text" name="se" placeholder="Genero" id="se" oninput="validacion('se')" required pattern="([A-Z ]{5,6})" maxlength="6"/>
					
			<input type="text" name="ma" placeholder="Matricula" id="ma" oninput="validacion('ma')" required pattern="([0-9 ]{9,9})" maxlength="9"/>
		
			<input type="text" name="ca" placeholder="Carrera" id="ca" oninput="validacion('ca')" required pattern="([A-Z] {25,50})" maxlength="50"/>  </input>

			<input type="text" name="s" placeholder="Semestre" id="s" oninput="validacion('s')" required pattern="([0-9 ]{1,1})" maxlength="1"/>

			<input type="text" name="act" placeholder="Actividad Complementaria" id="act" oninput="validacion('act')" required parttern="([A-Z ]{10, 50})" maxlength="50" >   </input>
...
$q1="INSERT INTO alumnos (nombre_a, apellido_p_a, apellido_m_a, edad, matricula, carrera, semestre, sexo, actividad) 
VALUES ('$no', '$ap', '$am', '$ed', '$ma', '$ca', '$s', '$se', 'act')";
